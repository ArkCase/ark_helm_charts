...
<Server port="8005" shutdown="SHUTDOWN">
  ...
  <Service name="Catalina">
    ...
    -->
    <Engine name="Catalina" defaultHost="localhost" jvmRoute="pentaho_tomcat">
      ...
      <Host name="localhost"  appBase="webapps"
        ...
        <Valve className="org.pentaho.tomcat.logvalve.FilteredAccessLogValve" directory="${LOGS_DIR}"
